...
module.exports = function(modelName, namm){
    ...
    var util_access = require('./util/access'), util_util = require('./util/util'), util_counts = require('./util/counts');

    return function(req, res) {

        util_access(modelName, namm); util_util(modelName, namm); util_counts(modelName, namm);
